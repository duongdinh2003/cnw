		...
		<section class="section">
			...
			<div>
				<table border=1 width=100%>
					...
					<% for (int i=0; i<bookingArray.size(); i++) { %>
						...
						<td align="center"><button>Gia hạn</button><a href="CancelTour?bookingId=<%=bookingArray.get(i).getBooking_id()%>"><button>Hủy</button></a></td>
					</tr>
					<% } %>
				</table>
			</div>
			...
			<div class="booking-form" id="booking-form">
				<div class="booking-form-content">
					<h2>
						Thông Tin Đặt Tour <span id="booking-form-close" onclick="hideBookingForm()">X Đóng</span>
					</h2>
